let lowQualityStream = "http://stream.zeno.fm/hhz1hyss5x8uv";
let highQualityStream = "https://stream.zeno.fm/hhz1hyss5x8uv";
let streamApi = "https://api.streamafrica.net/zeno/index.php?z=hhz1hyss5x8uv";

let rcast = "https://playlist.rcast.net/68396";
let rCast = "https://status.rcast.net/68396";
...
function whatIsPlaying() {
    ...
    xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200){
            document.getElementById('songs').innerHTML = JSON.parse(xmlHttp.responseText).title;
    ...
    currentTitle.textContent = "RADIO STEREO ROCK - A SUA RADIO ROCK NA INTERNET - O MELHOR DO ROCK'N'ROLL";
